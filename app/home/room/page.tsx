    ...
    <div className="grid grid-cols-3">
      <div className="col-span-2">
        <div className="relative h-full">
          <Image
            src="/users/person1.png"
            alt=""
            width={500}
            height={460}
            className="w-full h-full"
          />
          <div className="absolute w-42 h-32 z-10 top-2 left-2">
            <Image
      ...
      {/* Chat */}
      <div className="flex-1 col-span-1 p:2 px-4 justify-between flex flex-col h-[80vh]">
          ...
          <div className="relative flex items-center space-x-4">
            ...
            <div className="flex flex-col leading-tight">
              <div className="text-xl mt-1 flex items-center">
                <span className="text-gray-700 mr-3">Anderson Sierra</span>
              </div>
              <span className="text-lg text-gray-600">Estudiante</span>
            </div>
          </div>
        </div>
        <div
